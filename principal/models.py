...
class Persona(models.Model):
    ...
    numidentificacion = models.BigIntegerField(db_column='NumIdentificacion',verbose_name='Num Identificación')  # Field name made lowercase.
    numcelular = models.BigIntegerField(db_column='NumCelular',verbose_name='Num Celular')  # Field name made lowercase.
    numtelefono = models.BigIntegerField(db_column='NumTelefono', blank=True, null=True,verbose_name='Num Télefono')  # Field name made lowercase.
    correoelectronico = models.CharField(db_column='CorreoElectronico', max_length=45,verbose_name='Correo Electrónico')  # Field name made lowercase.
